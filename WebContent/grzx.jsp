					...
					<nav class="navbar navbar-default" role="navigation">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="grzx.jsp">个人中心</a></li>
	...
	<div class="single">
		<div class="container">
			<div class="single-top">
				...
				<div >	
					<h3><a href="grzx.jsp">修改个人信息</a></h3>
					<h6>我的信息</h6>
					<form action="/aaaaaa/UpdateStudent" method="post" >
					...
					<hr/>
					<div class="sinbt">
					<a class="hvr-shutter-in-horizontal"href="dl.jsp" onclick="action=ExitServlet">安全退出</a>
					</div>
				</div>
				<div class="clearfix"> </div>
			</div>
